...
void longest_common_substring(char* str1, char* str2, int m, int n, int len1, int len2)
{
	int **lcsLengths = malloc((m + 1) * sizeof(int *));;
	for (int k = 0; k < (m + 1); k++)
		lcsLengths[k] = (int*)malloc((n + 1) * sizeof(int));
